...
@NamedQueries({
    ...
    , @NamedQuery(name = "Credentials.findByPersonId", query = "SELECT c FROM Credentials c WHERE c.personid.personid = :personid")    
...
public class Credentials implements Serializable {
    ...
    public String toString() {
        return "restmemory.Credentials[ username=" + username + " ]";
    }
